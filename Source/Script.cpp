	...
	case Main:
	{
		...
		if (MenuClass::Option("Spawn Adder"))
		{
			...
			*(unsigned short*)g_Hooking.m_ModelSpawnBypass = 0x9090;
			...
			Vehicle Vehicle = VEHICLE::CREATE_VEHICLE(VehicleHash, Position.x, Position.y, Position.z, 0.f, TRUE, FALSE);
			*(unsigned short*)g_Hooking.m_ModelSpawnBypass = 0x0574;
			...
			if (NETWORK::NETWORK_IS_SESSION_STARTED())
			{
				...
				ENTITY::_SET_ENTITY_NOT_HAVE_ADVANCED_PHYSICS(Vehicle, TRUE);
